...
- cv_Load_FedReg_d_covid
 ...
 ### Процедура  medical_personal_sick
 
 Ежедневный отчет по заболевшим сотрудникам. Возввращает результат sql процедуры  med.p_StartMedicalPersonalSick в виде xlsx файла. Ничего особенного. Случайно затесался в этом модуле. 

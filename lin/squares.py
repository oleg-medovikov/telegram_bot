...
def paint_otchet_vachin(a):
    ...
    text_vachin = u"Вакцинированные на данный момент\n\nВсего: " +format(VACHIN,'n') + ' человек.'\
                    + u"\n\nСреди них больных: " + format(VACHIN_SICK, 'n') + ",\n\n    что составляет " +  format(round(100*VACHIN_SICK/VACHIN, 2 ), 'n') +'%' \
                    + u"\n\nСреди них умерших: " + format(VACHIN_DEATH, 'n') + ",\n\n    что составляет " +format(round(100*VACHIN_DEATH/VACHIN, 2 ),'n') +'%'    
    ...
    text_novachin = u"Невакцинированные на данный момент\n\nВсего: " +format(NOVACHIN,'n') + ' человек.'\
                    + u"\n\nСреди них больных: " + format(NOVACHIN_SICK, 'n') + ",\n\n    что составляет " +  format(round(100*NOVACHIN_SICK/NOVACHIN, 2 ), 'n') +'%' \
                    + u"\n\nСреди них умерших: " + format(NOVACHIN_DEATH, 'n') + ",\n\n    что составляет " +format(round(100*NOVACHIN_DEATH/NOVACHIN, 2 ), 'n') +'%'    

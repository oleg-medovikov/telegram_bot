SELECT  DAY, pok_01, nvl(cast(pok_02 as int),0) pok_02,
    ...
    nvl(cast(pok_78 as float),0) pok_78,nvl(cast(pok_79 as float),0) pok_79,nvl(cast(pok_80 as float),0) pok_80,nvl(cast(pok_81 as float),0) pok_81,
    nvl(cast(pok_82 as float),0) pok_82,nvl(cast(pok_83 as float),0) pok_83,nvl(cast(pok_84 as float),0) pok_84,nvl(cast(pok_85 as float),0) pok_85    
    FROM (
    SELECT 
    ...
    ,'29_covid_078' pok_78,'29_covid_079' pok_79,'29_covid_080' pok_80,'29_covid_081' pok_81
    ,'29_covid_082' pok_82,'29_covid_083' pok_83,'29_covid_084' pok_84,'29_covid_085' pok_85
    )
    )

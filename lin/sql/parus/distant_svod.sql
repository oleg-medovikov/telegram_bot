SELECT DAY, 'г.  Санкт Петербург' region, ORGANIZATION, POK02,
	...
	nvl(cast(pok16 as int),0) pok16, nvl(cast(pok17 as int),0) pok17,
	nvl(cast(pok18 as int),0) pok18
	FROM (
        SELECT
        ...
        and i.CODE IN ('distanc_consult_2_02', 'distanc_consult_2_03', 'distanc_consult_2_04', 'distanc_consult_2_05',
        		       ...
        		       'distanc_consult_2_15', 'distanc_consult_2_16', 'distanc_consult_2_17', 'distanc_consult_2_18')
        		       )
		pivot
        (
        max(value)
        ...
        'distanc_consult_2_15' pok15, 'distanc_consult_2_16' pok16, 'distanc_consult_2_17' pok17, 'distanc_consult_2_18' pok18

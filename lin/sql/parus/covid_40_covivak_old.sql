SELECT ORGANIZATION, 'Пункт вакцинации' type,  substr(KV_TVSP_02 ,1,INSTR(KV_TVSP_02 , ' ')-1) dist, 
        ...
        nvl(cast(KV_TVSP_27 as int),0)  KV_TVSP_27
                FROM (
                SELECT
                        r.BDATE day,
                ...
                and r.BDATE =  trunc(SYSDATE-1)
                 and i.CODE in ('KV_TVSP_02','KV_TVSP_04','KV_TVSP_05_z',
                                                ...
                                                , 'KV_TVSP_23_z', 'KV_TVSP_24', 'KV_TVSP_25_z', 'KV_TVSP_27')
                )
                pivot
                (
                max(value)
        ...
        'KV_TVSP_24'  KV_TVSP_24,'KV_TVSP_25_z'  KV_TVSP_25,'KV_TVSP_27'  KV_TVSP_27
        )
                )
        UNION
        ...
        nvl(cast(epy_vak_27 as int),0)  epy_vak_27
                FROM (
                SELECT
                ...
                WHERE rf.code = '40 COVID 19'
                 ...
                 and bi.CODE in ('epy_vak_01','epy_vak_02','epy_vak_04','epy_vak_05_z',
                                                ...
                                                , 'epy_vak_23_z', 'epy_vak_24', 'epy_vak_25_z', 'epy_vak_27')
                )
                pivot
                (
                max(value)
        ...
        'epy_vak_25_z'  epy_vak_25,'epy_vak_27'  epy_vak_27
        )
                )

SELECT 1 AS INDX, ORGANIZATION,'Всего' as typevacine,nvl(cast(cov_02 as int),0) cov_02
...
UNION all
SELECT 2 AS INDX, ORGANIZATION,'Гам-КОВИД-Вак (Спутник-V)' as  typevacine,nvl(cast(cov_02 as int),0) cov_02
		,nvl(cast(cov_03 as int),0) cov_03,nvl(cast(cov_04 as int),0) cov_04
		,nvl(cast(cov_05 as int),0) cov_05,nvl(cast(cov_06 as int),0) cov_06
		,nvl(cast(cov_07 as int),0) cov_07,nvl(cast(cov_08 as int),0) cov_08
		,nvl(cast(cov_09 as int),0) cov_09,nvl(cast(cov_10 as int),0) cov_10
...
UNION ALL
SELECT 3 AS INDX,ORGANIZATION,'КовиВак' as typevacine,nvl(cast(cov_02 as int),0) cov_02
		,nvl(cast(cov_03 as int),0) cov_03,nvl(cast(cov_04 as int),0) cov_04
		,nvl(cast(cov_05 as int),0) cov_05,nvl(cast(cov_06 as int),0) cov_06
		,nvl(cast(cov_07 as int),0) cov_07,nvl(cast(cov_08 as int),0) cov_08
		,nvl(cast(cov_09 as int),0) cov_09,nvl(cast(cov_10 as int),0) cov_10
...
UNION ALL 
SELECT 4 AS INDX,ORGANIZATION,'ЭпиВакКорона' as typevacine,nvl(cast(cov_02 as int),0) cov_02
		,nvl(cast(cov_03 as int),0) cov_03,nvl(cast(cov_04 as int),0) cov_04
		,nvl(cast(cov_05 as int),0) cov_05,nvl(cast(cov_06 as int),0) cov_06
		,nvl(cast(cov_07 as int),0) cov_07,nvl(cast(cov_08 as int),0) cov_08
		,nvl(cast(cov_09 as int),0) cov_09,nvl(cast(cov_10 as int),0) cov_10
...
UNION ALL 
SELECT 5 AS INDX, ORGANIZATION,'Спутник Лайт' as typevacine,nvl(cast(cov_02 as int),0) cov_02
		,nvl(cast(cov_03 as int),0) cov_03,nvl(cast(cov_04 as int),0) cov_04
		,nvl(cast(cov_05 as int),0) cov_05,nvl(cast(cov_06 as int),0) cov_06
		,nvl(cast(cov_07 as int),0) cov_07,nvl(cast(cov_08 as int),0) cov_08
		,nvl(cast(cov_09 as int),0) cov_09,nvl(cast(cov_10 as int),0) cov_10
